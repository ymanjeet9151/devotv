...
class SigninPage(PageObject):
    """
    WebElements and keywords for interacting with the Sign In / Sign Up page.

    This class defines locators and methods for interacting with the sign-in and sign-up elements on the page.
    It allows users to verify the presence of required page elements and perform other action based on the class.
    """
    _locators = {
    ...
    def _is_current_page(self):
        ...
        :return:
            - *bool*: Indicates whether both the signin_header_title and signin_button are present on the page.
        """
    ...
    def enter_user_email(self, email):
        ...
        This keyword contains 1 argument(s):
            - `email` (*str*): The email address to input into the appropriate email textbox.

        The method detects which email field is visible (based on standard or VADS flows) and
        inputs the provided email accordingly.
        """
    ...
    def enter_user_password(self, password):
        ...
        displayed.
        This keyword contains 1 argument(s):
            - `password` (*str*): The password to input into the appropriate password textbox.

        The method identifies which password field is currently displayed (standard or VADS flow)
        and enters the given password accordingly.
        """
