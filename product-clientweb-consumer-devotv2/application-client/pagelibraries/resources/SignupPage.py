...
class SignupPage(PageObject):
    """
    WebElements and keywords for interacting with the Sign Up page.

    This class defines locators and methods for interacting with elements on the sign-up page, including
    entering user details such as first name, last name, and email, as well as handling password
    fields and also other action.
    """
    _locators = {
    ...
    def _is_current_page(self):
        ...
        :return:
            - *bool*: Indicates whether both the signup_button and signup_header_title are present on the page.
        """
    ...
    def user_enter_firstName_for_signup(self, first_name):
        ...
        This keyword contains 2 argument(s):
            - `first_name` (*str*): The first name that the user wants to enter for signing up.
        """
    ...
    def user_enter_lastName_for_signup(self, last_name):
        ...
        This keyword contains 2 argument(s):
            - `last_name` (*str*): The last name that the user wants to enter for the signup process.
        """
