...
| | [Documentation] | Stops the execution and closes/terminates all opened browsers.
| | ... | **Returns**:
| | ... | *`None`* - This keyword does not return any value.
| | Log | \n... Closing Browser ...\n | console=${True}
| | Terminate all processes
| | Close all browsers

| Run Keyword If Test Failed
| | [Documentation] | Captures a screenshot when a test fails and clears the session.
